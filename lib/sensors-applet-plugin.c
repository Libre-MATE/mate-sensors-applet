...
void sensors_applet_plugin_find_sensors(
    GList **sensors, const gchar *path,
...
void sensors_applet_plugin_add_sensor(GList **sensors, const gchar *path,
  ...
  sensors_applet_plugin_add_sensor_with_limits(sensors, path, id, label, type,
                                               enable, low_value, high_value,
                                               icon, graph_color);
}
